    ...
    <div class="content-wrapper">
        ...
        <div class="content pl-5 pr-5 ">
            <div class="container pl-5 pr-5 border">
                ...
                <form id="permissions_config_update" name="permissions_config_update" id="permissions_config_update" method="post"
                                ...
                                <div class="row">
                                    ...
                                    @foreach($organizacioneCeline as $celina)
                                            ...
                                            <div class="col-sm-5 mt-2 border-bottom">
                                                <span class="font-weight-bold" id="{!! $celina->sifra_troskovnog_mesta !!}">{!! $celina->sifra_troskovnog_mesta !!}  {!! $celina->naziv_troskovnog_mesta !!}</span>
                                            </div>
                                            <div class="col-sm-1 mt-2">
                                            <input type="checkbox" {{(isset($poenterPermission) && $poenterPermission[$celina->sifra_troskovnog_mesta])  ? 'checked': ''}}  class="form-control"  name="troskovna_mesta_data[{{ $celina->sifra_troskovnog_mesta }}]" aria-label="{!! $celina->sifra_troskovnog_mesta !!}  {!! $celina->naziv_troskovnog_mesta !!}"  id="{!! $celina->sifra_troskovnog_mesta !!}">
                                            </div>
