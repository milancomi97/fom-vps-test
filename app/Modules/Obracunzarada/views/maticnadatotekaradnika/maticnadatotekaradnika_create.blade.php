                    ...
                    <div class="container mt-5">
                        <form id="maticnadatotekaradnika" method="post" action="{{ route('maticnadatotekaradnika.store')}}">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select maticni_broj" id="maticni_broj" name="maticni_broj"
...
{{--                                <input type="hidden" id="maticni_broj_value">--}}
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select prezime" id="prezime" name="prezime"
...
{{--                                <input type="hidden" id="prezime_value">--}}
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="ime" aria-describedby="ime" name="ime">
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select" id="sifra_mesta_troska_id" name="sifra_mesta_troska_id" aria-describedby="sifra_mesta_troska_id">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select" name="radno_mesto" id="radno_mesto" aria-describedby="radno_mesto">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select" id="isplatno_mesto" name="isplatno_mesto"
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="tekuci_racun" name="tekuci_racun"
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="redosled_poentazi" name="redosled_poentazi"
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select" id="vrsta_rada" name="vrsta_rada" aria-describedby="vrsta_rada">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="radna_jedinica" name="radna_jedinica"
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="brigada" name="brigada"
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" class="form-control" value="0" id="godine" name="godine" max="99" aria-describedby="godine">
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" class="form-control" name="meseci"  value="0" max="11" id="meseci" aria-describedby="meseci">
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="col col-1">
                                    <input type="checkbox" class="form-control" name="minuli_rad_aktivan" aria-label="Minuli rad aktivan" checked="checked"
                            ...
                            <div class="input-group mb-3">
                                ...
                                {{--                                $kvalifikacije--}}
                                <select class="custom-select" id="stvarna_strucna_sprema" name="stvarna_strucna_sprema"
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select" id="priznata_strucna_sprema" name="priznata_strucna_sprema"
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="osnovna_zarada" name="osnovna_zarada"
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="form-group ml-5"
                                    ...
                                    <div class="form-check form-check-inline ">
                                        <input class="form-check-input" type="radio" name="pol_muski" id="male" checked="checked" >
                                        <label class="form-check-label" for="male">Muški</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="pol_muski" id="female"
                                               value="female">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="prosecni_sati" value="0" name="prosecni_sati"
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="prosecna_zarada" name="prosecna_zarada"
                                       value="0"
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select" name="opstina_id" id="opstina_id" aria-describedby="opstina">
                            ...
                            <div class="row">
                                <div class="col-12 text-center mt-2  mb-5">
                                    <button id='submit_btn' type="submit" class="btn btn-primary btn-lg">Sačuvaj</button>
                                </div>
                            </div>
                        </form>
                    </div>
