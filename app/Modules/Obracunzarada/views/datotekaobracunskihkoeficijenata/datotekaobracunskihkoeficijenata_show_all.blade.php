...
{{--    <div class="container main-container mb-5">--}}
        ...
        <h2 class="text-center">Evidencija rada i odsustvovanje radnika VARIJABILNA</h2>
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($organizacionacelina as $value)
                            <tr>
                                ...
                                <td class="izmena_poentaže_td"
                                    data-record-id="{{$value['id']}}">
                                    <a href="{!! url('obracunzarada/datotekaobracunskihkoeficijenata/show?radnik_id=').$value['id']!!}">
